...
class AI_Search {
	...
	private function register_hooks() {
		add_action( 'save_post', array( $this, 'generate_embedding' ) );
		add_filter( 'posts_request', array( $this, 'custom_search_query' ), 10, 2 );
		add_action( 'admin_menu', array( $this, 'register_settings_menu' ) );
		add_action( 'admin_post_ai_search_generate_embeddings', array( $this, 'generate_selected_embeddings' ) );
	}
